...
- [project_docs.md](project_docs.md) — docs/ PPT、思维导图、UML、对比分析、架构思考文档
- [feedback_architecture_doc.md](feedback_architecture_doc.md) — 架构相关思考统一写入 docs/ontology_ai_architecture.md
- [feedback_architecture_approach.md](feedback_architecture_approach.md) — 避免过度设计，P0/P2 分级，等真实需求驱动实现
