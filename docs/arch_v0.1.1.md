# Palantir Architecture — v0.1.1

> 版本：v0.1.1 | 日期：2026-03-19 | 状态：设计阶段
>
> 更新规则：每日 refine → patch 版本递增；服务新增/删除 → minor；底层存储/协议更换 → major
>
> **v0.1.1 变更**：ADR-8 文件存储由"LocalFS → RustFS"改为"RustFS 从 P0 起"，用户上传场景本地 FS 无法多实例共享
