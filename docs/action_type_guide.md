...
### ADR-003: 产品定位——平台化，不是定制化

**决策**：本系统定位为"让客户自己能建模的平台"，而非"为每个客户做定制开发"。

**核心区别**：

| 定制方案 | 平台化（本系统） |
|---------|----------------|
| 每个客户都需要开发人员介入 | 行业模板 + 引导配置，业务人员自己搞定 |
| 不可规模化复制 | 可规模化，模板复用 |
| 技术人员是交付瓶颈 | 技术人员只在 Code Mode 极端场景兜底 |

**参照**：Palantir 的商业模式——卖的不是软件，是让客户自己能建模的能力。大客户愿意付高价，正是因为这套工具能替代原本需要雇一批顾问才能做的事。

**对设计的影响**：每个新功能的第一问题是"业务人员能否自己配置？"而不是"技术人员怎么实现？"
